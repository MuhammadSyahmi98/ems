                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    @endif
                                        ...
                                        <form method="POST" action="{{ route('password.email') }}">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><a class="small" href="{{Route('login')}}">{{__('Return to login')}}</a><button class="btn btn-primary" type="submit">{{ __('Send Password Reset Link') }}</button></div>
                                        </form>
                                    </div>
